...
class Pomodoro:
    ...
    def main(self):
        ...
        self.min_label = tk.Label(self.root,
            ...
            "ubuntu", 22, "bold"), bg="grey", fg='black')
        self.min_label.pack()
 
        self.sec_label = tk.Label(self.root,
                                  textvariable=self.sec, font=(
            "ubuntu", 22, "bold"), bg="black", fg='white')
        self.sec_label.pack()
 
        # aggiungere sfondo con Canvas widget
        """
